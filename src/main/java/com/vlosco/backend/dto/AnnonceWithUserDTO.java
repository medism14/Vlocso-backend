...
public class AnnonceWithUserDTO {
    ...
    @Schema(description = "L'annonce associée", example = "{ \"id\": 1, \"title\": \"Annonce Exemple\", \"description\": \"Description de l'annonce\" }")
    private Annonce annonce;

    @Schema(description = "L'utilisateur associé à l'annonce", example = "{ \"id\": 1, \"username\": \"utilisateurExemple\", \"email\": \"utilisateur@example.com\" }")
